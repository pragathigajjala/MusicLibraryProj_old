...
namespace MusicLibraryProj
{
    ...
    {
        public List<Song> songs = new List<Song>() { new Song() { SongName = "ChillLofi" }, new Song() { SongName = "Clouds" } };
        ...
        private void SupplyLevels_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
